...
const Privacy = () => {
  return (
    <div class="page">
      <div class="header">
        <div class="container">
          <p class="title">Privacy Policy for Caco2</p>
        </div>
      </div>
        ...
        <div class="container">
          <div class="tab-content translations-content-item en visible" id="en">
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Application</strong> refers to Caco2, the software
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Caco2,
                  Chennai, TamilNadu.
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p>By email: support@caco2.in</p>
              </li>
              <li>
                <p>
                  By visiting this page on our website:{" "}
                  <a
                    href="http://www.caco2.in"
