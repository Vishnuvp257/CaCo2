...
function termsCondition(props) {
	return (
		<div class='page'>
			<div class='header'>
				<div class='container'>
					<p class='title'>Terms & Conditions for Caco2</p>
				</div>
			</div>
				...
				<div class='container'>
					...
					<div
						...
						<p>
							...
							cancel it or caco2 cancels it. You may cancel your Subscription
							renewal either through your online account management page or by
							contacting support@caco2.in customer support team. A valid payment
							method is required to process the payment for your subscription.
							You shall provide caco2 with accurate and complete billing
							...
							information, you automatically authorize caco2 to charge all
							...
							any reason, caco2 reserves the right to terminate your access to
					...
					<div
						...
						<h3>6. Free Trial</h3>
						<p>
							caco2 may, at its sole discretion, offer a Subscription with a
						...
						<p>
							...
							Trial, you will not be charged by caco2 until Free Trial has
							...
							selected. At any time and without notice, caco2 reserves the right
					...
					<div
						...
						<h3>9. Content</h3>
						<p>
							ontent found on or through this Service are the property of caco2
					...
					<div
						class='tab-content translations-content-item en visible'
						id='en'>
						<h3>12. No Use By Minors under 14</h3>
						<p>
							Service is intended only for access and use by individuals at
							least fourteen (14) years old. By accessing or using Service, you
							warrant and represent that you are at least eighteen (14) years of
							...
							Terms. If you are not at least eighteen (14) years old, you are
					...
					<div
						...
						<p>
							...
							exclusive property of caco2 and its licensors. Service is
							...
							product or service without the prior written consent of caco2.
						</p>
					</div>
					<div
						class='tab-content translations-content-item en visible'
						...
						<p>
							...
							via email to support@caco2.in, with the subject line: “Copyright
					...
					<div
						...
						<p>
							You can contact our Copyright Agent via email at support@caco2.in.
						</p>
					</div>
					<div
						class='tab-content translations-content-item en visible'
						...
						<p>
							You may provide us either directly at support@caco2.in or via
					...
					<div
						...
						<p>
							...
							that are not owned or controlled by caco2. caco2 has no control
					...
					<div
						...
						<p>
							...
							support by email: support@caco2.in.
						</p>
					</div>
				</div>
			</div>
